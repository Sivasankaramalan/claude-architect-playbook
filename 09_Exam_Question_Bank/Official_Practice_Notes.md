...
- Take the official practice exam under time pressure.
- For every wrong answer, write the failure category: prompt, tool description, context, schema, decomposition, enforcement, or escalation.
- Re-test after a domain review.
