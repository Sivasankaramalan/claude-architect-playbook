...
This is the **Architect** track inside the [Claude Certification Playbook](../README.md). Sibling track: [`../developer/`](../developer/).

This guide is organized for fast revision, deep domain study, exam pattern recognition, and mock-practice drilling. It uses original summaries, architecture patterns, and practice prompts.
